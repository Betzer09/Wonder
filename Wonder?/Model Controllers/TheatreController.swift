...
//    }
    ...
    func fetchTheaterMoviesFromAPI(completion: @escaping ([TheatreMovies.TheaterMovie]) -> Void) {
        ...
        guard let userLocation = UserLocationController.shared.fetchUserLocation() else {return}
        let date = returnFormattedDateString(date: Date())
        
        // TODO: -  Fix these parameteres to have a unique zip and corret formatted date
        let parameters = ["api_key": "f63btc28rntf3tvv2j4tvvtp", "zip": userLocation.zip, "startDate": date]
